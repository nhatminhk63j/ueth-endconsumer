...
const DateField: React.FC<Props> = (props) => {
  ...
  const [dateFormatStr, setDateFormatStr] = React.useState(
    `${
      date ? date.format(DATE_FORMAT) : intl.formatMessage({ id: "IDS_SELECT_DATE" })
    }`
  );
      ...
      setDateFormatStr(
        `${
          time
            ...
            : intl.formatMessage({ id: "IDS_SELECT_DATE" })
        }`
      );
    },
        ...
        <div style={{ padding: isFocused ? "12px 12px 0px 12px" : undefined }}>
          <RootRef rootRef={innerRef}>
            <FormControlTextField
              ...
              inputComponent={
                isFocused ? (DateMaskCustomSingle as any) : undefined
              }
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <FormattedMessage id="IDS_SELECT_DATE" />
              </Button>
            </div>
          </Col>
        </CSSTransition>
